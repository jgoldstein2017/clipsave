Rails.application.routes.draw do
  ...
  # Routes for the Clip resource:
  # CREATE
  get "/clips/new", :controller => "clips", :action => "new"
  post "/create_clip", :controller => "clips", :action => "create"

  # READ
  get "/clips", :controller => "clips", :action => "index"
  get "/clips/:id", :controller => "clips", :action => "show"

  # UPDATE
  get "/clips/:id/edit", :controller => "clips", :action => "edit"
  post "/update_clip/:id", :controller => "clips", :action => "update"

  # DELETE
  get "/delete_clip/:id", :controller => "clips", :action => "destroy"
  #------------------------------
